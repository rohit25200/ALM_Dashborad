		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sapui5",
									"targetURL": "#dbalmdashboardapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dbalmdashboardapp-display": {
								"semanticObject": "dbalmdashboardapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=db.almdashboardapp",
									"url": sap.ui.require.toUrl("db/almdashboardapp")
								}
							}
						}
					}
